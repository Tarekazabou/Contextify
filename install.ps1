...
$batchContent = @"
@echo off
python "$currentDir\contextify.py" %*
"@

$batchPath = "$currentDir\contextify.bat"
...
Write-Host "   c. Add: $currentDir" -ForegroundColor Gray
Write-Host ""
Write-Host "🎉 Usage:" -ForegroundColor Cyan
Write-Host ""
Write-Host "   From this directory:" -ForegroundColor White
Write-Host "   .\contextify.bat 'add a dark mode toggle'" -ForegroundColor Gray
Write-Host "   .\contextify.bat 'create a user profile card' --focus frontend" -ForegroundColor Gray
Write-Host "   .\contextify.bat 'fix the bug' --changed" -ForegroundColor Gray
Write-Host ""
Write-Host "   If added to PATH, from anywhere:" -ForegroundColor White
Write-Host "   contextify 'add a dark mode toggle'" -ForegroundColor Gray
Write-Host ""
Write-Host "For help: .\contextify.bat --help" -ForegroundColor White
Write-Host ""
Write-Host "💡 Quick API Key Setup:" -ForegroundColor Cyan
Write-Host "   `$env:GEMINI_API_KEY='your-key'; .\contextify.bat 'your request'" -ForegroundColor Gray
